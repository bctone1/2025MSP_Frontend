...
export default function LoginPage({ className }) {
    ...
    return (
        <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-muted p-6 md:p-10" style={{ padding: '10px' }}>
            <div>
                <button
                    className="w-50 h-10 bg-gray-100 border border-black-100 cursor-pointer"
